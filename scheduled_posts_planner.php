...
add_action( 'add_meta_boxes', 'webins_add_custom_meta_box');

function webins_add_custom_meta_box()
{
    add_meta_box('webins-meta-box', 'Recent Scheduled Posts', 'webins_meta_box_markup', 'post', 'side', 'high');
}
